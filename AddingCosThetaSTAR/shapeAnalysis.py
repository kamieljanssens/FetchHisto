...
def main():
	...
	channels = ["dimuon_CI","dimuon_CI_BB","dimuon_CI_BE","dimuon_CI_CSPos","dimuon_CI_BB_CSPos","dimuon_CI_BE_CSPos","dimuon_CI_CSNeg","dimuon_CI_BB_CSNeg","dimuon_CI_BE_CSNeg","CosThetaStar"]
